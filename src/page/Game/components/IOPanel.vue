<template>
  <v-container ma-0 pa-0 class="game-iopanel">
    <v-tabs v-model="active">
      ...
      <v-tab key="importJournal" ripple>輸入紀錄</v-tab>
      <v-tab-item key="importJournal">
        <v-card flat>
          <v-card-text>
            <v-data-table :headers="headers" :items="$store.state.io.importJournal" hide-actions>
      ...
      <v-tab key="exportJournal" ripple>輸出紀錄</v-tab>
